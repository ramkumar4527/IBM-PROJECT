...
Original file is located at
    https://colab.research.google.com/drive/1y15rQDvuQG3nY_kdW39Lpks0C-KxyJY6
"""
...
def quiz_generator(concept):
    prompt = f"Generate 5 quiz questions about {concept} with different question types (multiple choice, true/false, short answer). At the end, provide answers."
